...
//	String img=baseFolder+"/dialog/window_dialog.gif";
	...
	String toolbar="تایید<img title='تایید' style='cursor:pointer' src='images/buttons/ok.png' id='confirmButtonDialog' onclick='closeDialog(\"dialog1\");[ONOKCLICKPLACEHOLDER]'/>انصراف<img title='انصراف' style='cursor:pointer' src='images/buttons/cancel.png' onclick='closeDialog(\"dialog1\");'/>";
	String toolbarExtra="";
	String onOKClick="";
