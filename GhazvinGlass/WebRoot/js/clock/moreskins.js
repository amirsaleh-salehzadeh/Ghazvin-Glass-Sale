CoolClock.config.skins = {
	...
	// by securephp
	securephp: {
		outerBorder:      { lineWidth: 100, radius: 0.45, color: "#35A7FF", alpha: 0.3 },
		smallIndicator:   { lineWidth: 2, startAt: 80, endAt: 90 , color: "#002E58", alpha: 1 },
		largeIndicator:   { lineWidth: 8.5, startAt: 20, endAt: 40 , color: "#002E58", alpha: 0.4 },
		hourHand:         { lineWidth: 3, startAt: 0, endAt: 60, color: "#002E58", alpha: 1 },
		minuteHand:       { lineWidth: 2, startAt: 0, endAt: 75, color: "#002E58", alpha: 1 },
		secondHand:       { lineWidth: 1, startAt: -10, endAt: 80, color: "#8DCDFF", alpha: 0.8 },
		secondDecoration: { lineWidth: 1, startAt: 70, radius: 4, fillColor: "#002E58", color: "red", alpha: 1 }
	},
