	  ...
	  <ams:paginate currentPage="<%=currentPage%>" pageSize="<%=pageSize%>" totalRows="<%=totalRows%>" align="center">
	    ...
	    <table align="center" dir="rtl" class="dataList">
	    	<tr>
	    		...
	    		<%if(request.getRemoteUser() !=null&&businessManager.security(request.getRemoteUser(),"administrator,usermng")){ %>
	    		<th nowrap>
	    			نقش ها
	    		</th>
	    		<%} %>
			...
			<logic:iterate id="userList" property="userENTs" type="ams.ggc.common.User.UserENT" name="userLST" indexId="rowId">
				<tr class="listData">
		    		...
		    		<%} if(request.getRemoteUser() !=null&&businessManager.security(request.getRemoteUser(),"administrator,usermng,floatmng,sheetmng")){ %>
		    		<td align="center">
