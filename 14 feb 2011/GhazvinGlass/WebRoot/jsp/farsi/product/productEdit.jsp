	...
	<input type="hidden" name="reqCode" id="reqCode" value="save">
	  <table align="center" class="formTable">
    	...
    	<tr>
    		...
    		<td>
    			<html:text property="thickness" name="productENT" ></html:text>میلی متر
    		</td>
    	</tr>
    	<tr>
    		<th valign="top" align="right">
    		...
    		<td>
    			<html:text property="price" name="productENT" ></html:text>ريال
    		</td>
    	</tr>
    	<tr>
    		<th valign="top" align="right">
    	...
    	<tr>
    		...
    		<td>
    			<html:text property="description" name="productENT" ></html:text>
    		</td>
    	</tr>
    	<tr>
    		<th valign="top" align="right">
