...
$(document).ready(function(){
	...
	$("#messageDiv").css("top", ( $(window).height() - $("#messageDiv").height() ) / 2+window.pageYOffset + "px");
	$("#messageDiv").css("left", ( $(window).width() - $("#messageDiv").width() ) / 2+window.pageXOffset + "px");
});
...
createTransparentBg4Message = function(){
	...
	bgObj.style.left="0"; 
	bgObj.style.width= (WindowRightEdge + 150) + "px"; 
	bgObj.style.height= (WindowBottomEdge + 150) + "px"; 
