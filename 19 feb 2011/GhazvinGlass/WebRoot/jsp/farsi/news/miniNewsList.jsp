	...
	<table width="210" dir="rtl" class="dataList">
		<tr>
			<td colspan="2" align="center">
				<h1><a onclick="" href="t_news.do?reqCode=list&language=farsi" style="cursor: pointer;">اخبار</a></h1>
			</td>
		</tr>	
		<tr>
			<th>
		...
		<logic:iterate id="miniNewsList" property="newsENTs" type="ams.ggc.common.NEWS.NewsENT" name="newsMiniLST">
			<tr>
				<td>
